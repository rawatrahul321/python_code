...
"""
Translation of a number into text.
Directed by: 

Please do not remove my URL / URL; thank you in advance

Usage : See the examples at the end of the script..

Note : Translation franco-francaise, with variable units, spelling gere, unites et centiemes.
"""
...
def trad(nb, unite="INR", decim="Paise"):
    global t1,t2
    nb=round(nb,2)
    ...
    t2=["","Ten","Twenty","Thirty","Forty","Fifty","Sixty","Seventy","Eighty","Ninety"]
    z1=int(nb)
    z3=(nb-z1)*100
    z2=int(round(z3,0))
    if z1==0:
...
#     print 1,trad(1)
#     print 2.2,trad(2.2)
#     print 12.30,trad(12.30,'hour','minute')
#     print 12.30,trad(12.30,'hour','')
