...
class website_account(website_account):
    ...
    def account(self, **kw):
        ...
        OrderForm = request.env['order.form']
...
#         custom_quotes_count = OrderForm.search_count([
#             ('message_partner_ids', 'child_of', [partner.commercial_partner_id.id])
#         ])
...
#             'custom_quotes_count': custom_quotes_count,
        })
        return response

    #
    # Custom Quotes -- Order Form
    #

   
    @http.route(['/my/custom_quotes', '/my/custom_quotes/page/<int:page>'], type='http', auth="user", website=True)
    def portal_custom_quotes(self, page=1, date_begin=None, date_end=None, **kw):
        ...
        # count for pager
        order_count = OrderForm.search_count(domain)
        # pager
        pager = request.website.pager(
            url="/my/custom_quotes",
        ...
        orders = OrderForm.search(domain, limit=self._items_per_page, offset=pager['offset'])
