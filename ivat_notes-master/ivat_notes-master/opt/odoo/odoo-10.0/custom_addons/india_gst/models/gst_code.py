...
class AccountInvoiceLine(models.Model):
    ...
    cgst = fields.Float(string='CGST', digits=dp.get_precision('Product Price'),store=True)
    sgst = fields.Float(string='SGST', digits=dp.get_precision('Product Price'),store=True)
    igst = fields.Float(string='IGST', digits=dp.get_precision('Product Price'),store=True)
