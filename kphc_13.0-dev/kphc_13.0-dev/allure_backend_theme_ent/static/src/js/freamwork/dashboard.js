odoo.define('allure_backend_theme_ent.DashboardCustomizeTheme', function (require) {
    ...
    var CustomizeThemeDialog = Dialog.extend({
        ...
        start: function () {
            ...
            if (!_.isEmpty(this.allureThemes)) {
                this.current_theme = _.findWhere(this.allureThemes, {selected: true});
                if (!_.isUndefined(this.current_theme)) {
                    self._setSelectedTheme(_.findWhere(self.allureThemes, {id: self.current_theme.id}), true);
                }
            }
        ...
        _onClickSelectTheme: function (e) {
            ...
            if (res_id !== 0) {
                self._setSelectedTheme(_.findWhere(self.allureThemes, {id: res_id}), false);
            }
        },
