...
class MailMail(models.Model):
    """Inherited model holding RFC2822 email messages to send.
    Adding Bcc email address.
    """
    _inherit = 'mail.mail'
    ...
    def _send(self, auto_commit=False, raise_exception=False, smtp_session=None):
        """Override standard method and hide standard's code.

        Add bcc compare to odoo 12 standard code for build_email() function.
        There is no way allowed to pass bcc from here so no alternate way.
        """
